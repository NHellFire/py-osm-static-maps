...
def get_argparser():
    ...
    parser.add_argument("-Z", "--maxZoom", help="Maximum zoomlevel of the map (default: vectorserverUrl ? 20 : 17)", action="store", type=float, default=argparse.SUPPRESS)
    parser.add_argument("-z", "--zoom", help="Zoomlevel of the map", action="store", type=float, default=17)
...
staticFiles.load("mapboxcss", "static/maplibre-gl.css")
staticFiles.load("mapboxjs", "static/maplibre-gl.js")
...
staticFiles.load("leafletmapboxjs", "static/leaflet-maplibre-gl.js")
